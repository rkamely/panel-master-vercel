...
function ComparativeDonatesReport() {
...
// Create chart instance
        let chart = am4core.create("comparativeDonatesReport", am4charts.XYChart);
...
// Create value axis
        ...
        valueAxis.title.text = "مبلغ نیکوکاری";
...
//         })
    ...
    return (
        ...
        <>
            <div id="comparativeDonatesReport" style={{width: "100%", height: "400px"}}/>
        </>

    );
}

export default ComparativeDonatesReport;
